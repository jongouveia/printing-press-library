...
func New(cfg *config.Config, timeout time.Duration, rateLimit float64) *Client {
	...
	cacheDir := filepath.Join(homeDir, ".cache", "github.com/mvanhorn/printing-press-library/library/productivity/expensify", "http")
...
func authPlaceholderCredentialError(cfg *config.Config) error {
	return authPlaceholderCredentialErrorWithSetup(cfg, "export EXPENSIFY_AUTH_TOKEN=<your-token> or github.com/mvanhorn/printing-press-library/library/productivity/expensify auth set-token <token>")
}
