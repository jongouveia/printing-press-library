...
func newDamageCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify damage
  github.com/mvanhorn/printing-press-library/library/productivity/expensify damage --month previous
  github.com/mvanhorn/printing-press-library/library/productivity/expensify damage --month 2026-02 --policy ABC123`,
