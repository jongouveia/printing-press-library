...
func newSyncCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  github.com/mvanhorn/printing-press-library/library/productivity/expensify sync\n  github.com/mvanhorn/printing-press-library/library/productivity/expensify sync --since 2026-01-01",
