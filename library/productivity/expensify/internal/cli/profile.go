...
func profileStorePath() (string, error) {
	...
	dir := filepath.Join(home, ".github.com/mvanhorn/printing-press-library/library/productivity/expensify")
...
present (other than --profile and --config).`,
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile save my-defaults --json --compact
  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile save tonight-defaults --region US`,
...
func newProfileUseCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile use my-defaults
  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile use tonight-defaults --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
...
func newProfileListCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile list
  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile list --json`,
...
func newProfileShowCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile show my-defaults
  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile show tonight-defaults --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			p, err := GetProfile(args[0])
			if err != nil {
...
func newProfileDeleteCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile delete my-defaults --yes
  github.com/mvanhorn/printing-press-library/library/productivity/expensify profile delete old-profile --yes --json`,
		Args: cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			name := args[0]
			s, err := loadProfileStore()
