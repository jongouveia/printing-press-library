...
func feedbackFilePath() (string, error) {
	...
	dir := filepath.Join(home, ".local", "share", "github.com/mvanhorn/printing-press-library/library/productivity/expensify")
...
func postFeedback(url string, entry FeedbackEntry) error {
	...
	req.Header.Set("User-Agent", "github.com/mvanhorn/printing-press-library/library/productivity/expensify/feedback")
...
func newFeedbackCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Long: `Feedback is captured locally first at ~/.local/share/github.com/mvanhorn/printing-press-library/library/productivity/expensify/feedback.jsonl.
...
maintainer sees it.`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			entry := FeedbackEntry{
				Text:      text,
				CLI:       "github.com/mvanhorn/printing-press-library/library/productivity/expensify",
				Version:   version,
...
func newFeedbackListCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify feedback list
  github.com/mvanhorn/printing-press-library/library/productivity/expensify feedback list --limit 5
  github.com/mvanhorn/printing-press-library/library/productivity/expensify feedback list --json`,
