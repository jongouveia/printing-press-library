...
into date / merchant / amount. Card prefixes (AMEX*, SQ*, TST*, PP*) are stripped.`,
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense from-line "2026-04-18 DOORDASH*JOES $14.25"
  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense from-line "04/18 SQ*BLUE BOTTLE 6.50" --category Meals`,
