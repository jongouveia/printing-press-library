...
func newExpenseMissingReceiptsCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense missing-receipts
  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense missing-receipts --since 2026-01-01`,
