...
func (f *fakePoster) Post(path string, body any) (json.RawMessage, int, error) {
...
func TestResolveExpenseDeleteRefs(t *testing.T) {
	...
	rid, aid, err := resolveExpenseDeleteRefs(f, "111")
	if err != nil {
...
func TestResolveExpenseDeleteRefs_NotFound(t *testing.T) {
	...
	if _, _, err := resolveExpenseDeleteRefs(f, "111"); err == nil {
