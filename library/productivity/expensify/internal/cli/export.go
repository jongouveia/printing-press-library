...
large datasets as it has no memory pressure.`,
  ...
  github.com/mvanhorn/printing-press-library/library/productivity/expensify export <resource> --format jsonl --output data.jsonl

  # Export with limit
  github.com/mvanhorn/printing-press-library/library/productivity/expensify export <resource> --format jsonl --limit 1000

  # Pipe to another tool
  github.com/mvanhorn/printing-press-library/library/productivity/expensify export <resource> --format jsonl | jq '.id'`,
	...
	// Integration Server export subcommands (run reports, download files)
	cmd.AddCommand(newExportRunCmd(flags))
	cmd.AddCommand(newExportDownloadCmd(flags))
