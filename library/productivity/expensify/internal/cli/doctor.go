...
func newDoctorCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify doctor
  github.com/mvanhorn/printing-press-library/library/productivity/expensify doctor --json
  github.com/mvanhorn/printing-press-library/library/productivity/expensify doctor --fail-on warn`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if cfg != nil {
				...
				if header == "" {
					...
					report["auth_hint"] = "export EXPENSIFY_AUTH_TOKEN=<your-key>"
			...
			if cfg != nil && cfg.BaseURL != "" {
				...
				if clientErr != nil {
					...
					if authHeader == "" {
						...
						if suggestion != "" {
							report["credentials"] = fmt.Sprintf("present, not verified. Run `%s %s` to confirm the token works end-to-end.", "github.com/mvanhorn/printing-press-library/library/productivity/expensify", suggestion)
						} else {
