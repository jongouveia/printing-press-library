...
defaults. --report attaches every created expense to a report.`,
		Example: `  cat rows.jsonl | github.com/mvanhorn/printing-press-library/library/productivity/expensify expense bulk --input - --report 12345
  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense bulk -i rows.jsonl --category "Facilities - Office Supplies & Printing" --tag "101 G&A" --dry-run`,
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, status, err := c.Post("/Expense_Create", body)
			if err != nil {
