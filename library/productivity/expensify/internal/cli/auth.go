...
func newAuthSetupCmd(_ *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: "  github.com/mvanhorn/printing-press-library/library/productivity/expensify auth setup\n  github.com/mvanhorn/printing-press-library/library/productivity/expensify auth setup --launch",
		RunE: func(cmd *cobra.Command, args []string) error {
			w := cmd.OutOrStdout()
			fmt.Fprintln(w, "Get a key at: https://www.expensify.com/tools/integrations/")
			fmt.Fprintln(w, "")
			fmt.Fprintln(w, "Then set:")
			fmt.Fprintln(w, "  export EXPENSIFY_AUTH_TOKEN=\"<your-token>\"")
			fmt.Fprintln(w, "  export EXPENSIFY_PARTNER_USER_ID=\"<your-token>\"")
			fmt.Fprintln(w, "  export EXPENSIFY_PARTNER_USER_SECRET=\"<your-token>\"")
			fmt.Fprintln(w, "  github.com/mvanhorn/printing-press-library/library/productivity/expensify auth set-token <token>")
			if !launch {
				return nil
			}
	...
	return &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if !authed {
				...
				fmt.Fprintf(w, "  github.com/mvanhorn/printing-press-library/library/productivity/expensify auth set-token <token>\n")
				return authErr(fmt.Errorf("no credentials configured"))
			}
...
func newAuthSetTokenCmd(flags *rootFlags) *cobra.Command {
	return &cobra.Command{
		...
		Example: "  github.com/mvanhorn/printing-press-library/library/productivity/expensify auth set-token YOUR_TOKEN_HERE",
