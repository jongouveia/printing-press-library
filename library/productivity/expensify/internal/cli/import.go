...
but do not stop the import.`,
  ...
  github.com/mvanhorn/printing-press-library/library/productivity/expensify import <resource> --input data.jsonl

  # Dry-run to preview without sending
  github.com/mvanhorn/printing-press-library/library/productivity/expensify import <resource> --input data.jsonl --dry-run

  # Import from stdin
  cat data.jsonl | github.com/mvanhorn/printing-press-library/library/productivity/expensify import <resource> --input -`,
