...
func newExpenseRollupCmd(flags *rootFlags) *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		Example: `  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense rollup
  github.com/mvanhorn/printing-press-library/library/productivity/expensify expense rollup --month 2026-03 --by merchant`,
